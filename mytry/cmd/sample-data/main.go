...
func main() {
	...
	errRev := reviewer.AddReviewSampleS(DefaultReviews)

	fmt.Printf("finish add default beers: %v", errBeer)
	fmt.Printf("finish add default reviews: %v", errRev)
}
...
var DefaultReviews = []reviewing.Review{
	{BeerID: "beer_1b5fdb31d69af5ca", FirstName: "Joe", LastName: "Tribiani", Score: 5, Text: "This is good but this is not pizza!"},
